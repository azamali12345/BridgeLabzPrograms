...
public class QueueList<T> 
{
	...
	{
		Node temp=head;
		System.out.println("DATA IN QUEUE LIST...");
		while(temp!=null)
		{
	...
	public static void write()
	{
		...
		s1=sb.toString();
		s=s1.split(" ");
		try (BufferedWriter bw = new BufferedWriter(new FileWriter("/home/admin1/Desktop/txt2")))
		{
	...
	public void write1()
	{
		...
		try (BufferedWriter bw = new BufferedWriter(new FileWriter("/home/admin1/Desktop/txt1")))
		{
			bw.write(str);
			System.out.println("DONE...");
			bw.close();
